...
const Testimonial = () => {
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto mb-6 md:mb-8 lg:mb-16">
           <h2 className="text-center  bg-clip-text text-transparent  bg-gradient-to-r from-indigo-700 from-10% via-sky-700 via-30% to-emerald-700 to-90% decoration-wavy text-xl md:text-2xl lg:text-3xl  font-extrabold italic mt-8 mb-10">Our event review</h2>
